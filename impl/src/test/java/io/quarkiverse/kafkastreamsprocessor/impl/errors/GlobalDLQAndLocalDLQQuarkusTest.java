...
@QuarkusTest
@TestProfile(GlobalDLQAndLocalDLQQuarkusTest.TestProfile.class)
public class GlobalDLQAndLocalDLQQuarkusTest {
    private static final String GLOBAL_DLQ_TOPIC = "global-dlq-topic";

  private static final String LOCAL_DLQ_TOPIC = "local-dlq-topic";
    ...
    KafkaConsumer<String, PingMessage.Ping> localDlqConsumer;

  KafkaConsumer<String, PingMessage.Ping> globalDlqConsumer;
    ...
    public void setup() {
      ...
      localDlqConsumer = new KafkaConsumer<>(dlqConsumerProps, new StringDeserializer(),
  ...
  public static class TestProfile implements QuarkusTestProfile {
    ...
    public Set<Class<?>> getEnabledAlternatives() {
      return Collections.singleton(LogAndSendToDlqExceptionHandlerDelegateQuarkusTest.TestProcessor.class);
    }

    @Override
    public Map<String, String> getConfigOverrides() {
      return Map.of("kafkastreamsprocessor.error-strategy", "dead-letter-queue",
          "kafkastreamsprocessor.dlq.topic", LOCAL_DLQ_TOPIC,
      "kafkastreamsprocessor.global-dlq.topic", GLOBAL_DLQ_TOPIC,
          "kafkastreamsprocessor.global-dlq.max-message-size", Integer.toString(Integer.MAX_VALUE),
          "kafka-streams.max.request.size", "300");
    }
  }
