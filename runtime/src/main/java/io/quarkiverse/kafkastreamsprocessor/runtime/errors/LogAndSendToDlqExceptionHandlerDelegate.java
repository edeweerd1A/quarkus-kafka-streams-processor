 ...
 * #L%
 */
package io.quarkiverse.kafkastreamsprocessor.runtime.errors;
...
public class LogAndSendToDlqExceptionHandlerDelegate implements DeserializationExceptionHandler {
     ...
     *
     * @param kafkaClientSupplier
     *        a supplier of {@link org.apache.kafka.clients.producer.KafkaProducer}
     * @param metrics
     ...
     * {@link KafkaClientSupplierDecorator#DLQ_PRODUCER} flag so it is only decorated with
     * {@link ProducerOnSendInterceptor} that have {@link ProducerOnSendInterceptor#skipForDLQ()} returning
     * <code>false</code>.
     * <p>
