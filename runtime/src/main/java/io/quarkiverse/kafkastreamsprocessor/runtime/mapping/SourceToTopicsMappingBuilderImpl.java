...
@ApplicationScoped
@Slf4j
public class SourceToTopicsMappingBuilderImpl implements SourceToTopicsMappingBuilder {
    /**
     ...
     */
    @Inject
    public SourceToTopicsMappingBuilderImpl(KStreamsProcessorConfig extensionConfiguration) {
    ...
    // */
    // public SourceToTopicsMappingBuilderImpl(Config config) {
