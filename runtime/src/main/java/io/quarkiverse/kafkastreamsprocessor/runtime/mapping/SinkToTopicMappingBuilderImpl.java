...
@ApplicationScoped
@Slf4j
public class SinkToTopicMappingBuilderImpl implements SinkToTopicMappingBuilder {
    /**
     ...
     */
    @Inject
    public SinkToTopicMappingBuilderImpl(KStreamsProcessorConfig extensionConfiguration) {
    ...
    // */
    // public SinkToTopicMappingBuilderImpl(Config config) {
