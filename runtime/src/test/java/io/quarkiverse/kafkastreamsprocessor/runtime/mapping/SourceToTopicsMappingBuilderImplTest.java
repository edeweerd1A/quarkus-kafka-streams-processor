...
public class SourceToTopicsMappingBuilderImplTest {
    @Mock
    ...
    SourceToTopicsMappingBuilderImpl sourceConfiguration;

    @BeforeEach
    void setUp() {
        sourceConfiguration = new SourceToTopicsMappingBuilderImpl(extensionConfiguration);
