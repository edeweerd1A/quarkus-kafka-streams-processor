...
import static io.quarkiverse.kafkastreamsprocessor.runtime.protocol.KafkaStreamsProcessorHeaders.W3C_BAGGAGE;
import static io.quarkiverse.kafkastreamsprocessor.runtime.protocol.KafkaStreamsProcessorHeaders.W3C_TRACE_ID;
...
public class TracingDecoratorTest {
    ...
    void shouldPropagateOpentelemetryW3CBaggage() {
        ...
        // the opentelemetry injected and used throughout the unit tests in this class is not configured with W3C baggage
        // propagator
