...
public class SinkToTopicMappingBuilderImplTest {
    @Mock
    ...
    SinkToTopicMappingBuilderImpl sinkConfiguration;

    @BeforeEach
    void setUp() {
        sinkConfiguration = new SinkToTopicMappingBuilderImpl(extensionConfiguration);
